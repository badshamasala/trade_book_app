...
class CandelChart extends StatefulWidget {
  CandelChart({Key? key, }) : super(key: key);
  ...
  @override
  _CandelChartState createState() => _CandelChartState();
}

class _CandelChartState extends State<CandelChart> {
